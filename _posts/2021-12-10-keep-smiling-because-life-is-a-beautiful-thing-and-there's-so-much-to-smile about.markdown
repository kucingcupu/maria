...
<div class="gallery-box">
  <div class="gallery gallery--post">
    <img src="{{site.baseurl}}/images/32.jpg" loading="lazy" alt="Mountains">
    <img src="{{site.baseurl}}/images/33.jpg" loading="lazy" alt="Woman">
    <img src="{{site.baseurl}}/images/34.jpg" loading="lazy" alt="Subway">
    <img src="{{site.baseurl}}/images/35.jpg" loading="lazy" alt="City">
  </div>
